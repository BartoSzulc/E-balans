...
<article data-aos="fade-up" data-aos-delay="{{ $aos_delay }}"
    class="relative z-10 flex flex-col bg-white shadow-special rounded-32 lg:pt-60 lg:pb-32 lg:px-32">
    <div class="absolute top-0 -translate-y-1/2 left-20 lg:left-32 size-36 lg:size-72">

        <svg class="size-72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col gap-16 grow">
        ...
        <a href="{{ $pdf_url }}" target="_blank" rel="noopener noreferrer"
            class="flex items-center space-x-8 transition-all duration-300 ease-in-out group hover:text-color-2 lg:mt-16">
            <span>Sprawdź</span>
            <svg class="duration-300 size-24 translate-all ease-power1-in group-hover:translate-x-2" viewBox="0 0 24 24"
