...
<header class="relative w-full py-20 lg:pt-32 main-header z-999" role="banner">
        ...
        <div class="relative flex items-center justify-between gap-60">
            ...
            <div class="flex items-center self-start w-300">
                <a class="brand" href="{{ home_url('/') }}" aria-label="E-balans - Strona główna">
                    <img src="@asset('resources/images/logo.png')" class="h-48" alt="E-balans Logo">
                </a>
            </div>
            ...
            <div class="flex items-center justify-end ">
                <div class="inline-flex">
                    {{ acf_link($header['button'], 'btn btn--primary');}}
                </div>
            </div>
            @endif
        </div>
...
{{-- Sticky Header --}}
<div class="fixed top-0 w-full py-20 transition-all duration-500 ease-in-out transform -translate-y-full bg-white opacity-0 lg:pt-32 banner main-header--sticky z-999"
