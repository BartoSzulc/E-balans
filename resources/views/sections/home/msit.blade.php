            ...
            <div
                ...
                <div class="absolute right-238 top-32">
                    <svg class="w-622 h-539" viewBox="0 0 622 539" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="370.384" cy="93.7546" r="93.7546" fill="#5477AD" />
                        <circle cx="490.875" cy="206.403" r="130.829" fill="#BEC6D0" />
                        <circle cx="225.653" cy="313.347" r="225.653" fill="#B1BCCC" />
                    </svg>
                ...
                <div class="flex flex-col">
                    ...
                    @if ($msit['title'])
                        <h2 class="mt-24 msit-title text-h2">
                            {!! $msit['title'] !!}
                        </h2>
                    @endif
                </div>
                ...
                @if ($msit['image'])
                    <div class="relative z-10 msit-image">
