...
export function initPartnersSlider() {
  const swiperInstances = [];
    ...
    document.querySelectorAll('.swiperPartners').forEach(el => {
        ...
        let carouselTestimonialSwiper = new Swiper(el, {
            ...
            on: {
                init: function() {
                    ...
                    const navButtons = document.querySelectorAll('.swiperPartners__nav');
        ...
        swiperInstances.push(carouselTestimonialSwiper);

    });

    const nextButtons = document.querySelectorAll('.swiperPartners__nav--next');
    const prevButtons = document.querySelectorAll('.swiperPartners__nav--prev');
